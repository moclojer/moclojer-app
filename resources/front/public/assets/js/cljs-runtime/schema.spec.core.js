...
var schema$spec$core$CoreSpec$subschemas$dyn_36664 = (function (this$){
...
return schema$spec$core$CoreSpec$subschemas$dyn_36664(this$);
}
});

var schema$spec$core$CoreSpec$checker$dyn_36665 = (function (this$,params){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return schema$spec$core$CoreSpec$checker$dyn_36665(this$,params);
}
});
...
var G__36648 = schema.utils.value_name(x);
return (err_f.cljs$core$IFn$_invoke$arity$1 ? err_f.cljs$core$IFn$_invoke$arity$1(G__36648) : err_f.call(null,G__36648));
}),null)),reason));
} else {
return null;
}
...
var G__36654 = (new cljs.core.Delay((function (){
var fexpr__36655 = cljs.core.deref(cache);
return (fexpr__36655.cljs$core$IFn$_invoke$arity$1 ? fexpr__36655.cljs$core$IFn$_invoke$arity$1(cache_key) : fexpr__36655.call(null,cache_key));
}),null));
return (wrap_recursive_delay.cljs$core$IFn$_invoke$arity$1 ? wrap_recursive_delay.cljs$core$IFn$_invoke$arity$1(G__36654) : wrap_recursive_delay.call(null,G__36654));
} else {
return w;
}
} else {
 ...
 */
schema.spec.core.sub_checker = (function schema$spec$core$sub_checker(p__36659,p__36660){
var map__36661 = p__36659;
var map__36661__$1 = cljs.core.__destructure_map(map__36661);
var schema__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36661__$1,new cljs.core.Keyword(null,"schema","schema",-1582001791));
var error_wrap = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36661__$1,new cljs.core.Keyword(null,"error-wrap","error-wrap",-1295833514));
var map__36662 = p__36660;
var map__36662__$1 = cljs.core.__destructure_map(map__36662);
var params = map__36662__$1;
var subschema_checker = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36662__$1,new cljs.core.Keyword(null,"subschema-checker","subschema-checker",1137701360));
var cache = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36662__$1,new cljs.core.Keyword(null,"cache","cache",-1237023054));
var sub = schema.spec.core.with_cache(cache,schema__$1,(function (d){
return (function (x){
var fexpr__36663 = cljs.core.deref(d);
return (fexpr__36663.cljs$core$IFn$_invoke$arity$1 ? fexpr__36663.cljs$core$IFn$_invoke$arity$1(x) : fexpr__36663.call(null,x));
});
}),(function (){
