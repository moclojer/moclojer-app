...
var schema_tools$walk$WalkableSchema$_walk$dyn_39972 = (function (this$,inner,outer){
...
return schema_tools$walk$WalkableSchema$_walk$dyn_39972(this$,inner,outer);
}
});
...
var G__39869 = cljs.core.with_meta(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (r,x){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(r,(inner.cljs$core$IFn$_invoke$arity$1 ? inner.cljs$core$IFn$_invoke$arity$1(x) : inner.call(null,x)));
}),this$,this$),cljs.core.meta(this$));
return (outer.cljs$core$IFn$_invoke$arity$1 ? outer.cljs$core$IFn$_invoke$arity$1(G__39869) : outer.call(null,G__39869));
} else {
if(cljs.core.seq_QMARK_(this$)){
var G__39870 = cljs.core.with_meta(cljs.core.doall.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2(inner,this$)),cljs.core.meta(this$));
return (outer.cljs$core$IFn$_invoke$arity$1 ? outer.cljs$core$IFn$_invoke$arity$1(G__39870) : outer.call(null,G__39870));
} else {
if(cljs.core.coll_QMARK_(this$)){
var G__39878 = cljs.core.with_meta(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.empty(this$),cljs.core.map.cljs$core$IFn$_invoke$arity$2(inner,this$)),cljs.core.meta(this$));
return (outer.cljs$core$IFn$_invoke$arity$1 ? outer.cljs$core$IFn$_invoke$arity$1(G__39878) : outer.call(null,G__39878));
} else {
return (outer.cljs$core$IFn$_invoke$arity$1 ? outer.cljs$core$IFn$_invoke$arity$1(this$) : outer.call(null,this$));
...
var this$__$1 = this;
var G__39923 = cljs.core.with_meta(cljs.core.vec(cljs.core.map.cljs$core$IFn$_invoke$arity$2(inner,this$__$1)),cljs.core.meta(this$__$1));
return (outer.cljs$core$IFn$_invoke$arity$1 ? outer.cljs$core$IFn$_invoke$arity$1(G__39923) : outer.call(null,G__39923));
}));
...
var this$__$1 = this;
var G__39924 = cljs.core.with_meta(schema.core.__GT_ConditionalSchema(cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__5523__auto__ = (function schema_tools$walk$iter__39925(s__39926){
return (new cljs.core.LazySeq(null,(function (){
var s__39926__$1 = s__39926;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__39926__$1);
if(temp__5804__auto__){
var s__39926__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__39926__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__39926__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__39928 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__39927 = (0);
while(true){
if((i__39927 < size__5522__auto__)){
var vec__39930 = cljs.core._nth(c__5521__auto__,i__39927);
var pred = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39930,(0),null);
var schema__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39930,(1),null);
cljs.core.chunk_append(b__39928,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [pred,(inner.cljs$core$IFn$_invoke$arity$1 ? inner.cljs$core$IFn$_invoke$arity$1(schema__$1) : inner.call(null,schema__$1))], null));

var G__39987 = (i__39927 + (1));
i__39927 = G__39987;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__39928),schema_tools$walk$iter__39925(cljs.core.chunk_rest(s__39926__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__39928),null);
}
} else {
var vec__39933 = cljs.core.first(s__39926__$2);
var pred = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39933,(0),null);
var schema__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39933,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [pred,(inner.cljs$core$IFn$_invoke$arity$1 ? inner.cljs$core$IFn$_invoke$arity$1(schema__$1) : inner.call(null,schema__$1))], null),schema_tools$walk$iter__39925(cljs.core.rest(s__39926__$2)));
}
} else {
return null;
}
...
return (outer.cljs$core$IFn$_invoke$arity$1 ? outer.cljs$core$IFn$_invoke$arity$1(G__39924) : outer.call(null,G__39924));
}));
...
var this$__$1 = this;
var G__39938 = cljs.core.with_meta(schema.core.maybe((function (){var G__39939 = this$__$1.schema;
return (inner.cljs$core$IFn$_invoke$arity$1 ? inner.cljs$core$IFn$_invoke$arity$1(G__39939) : inner.call(null,G__39939));
})()),cljs.core.meta(this$__$1));
return (outer.cljs$core$IFn$_invoke$arity$1 ? outer.cljs$core$IFn$_invoke$arity$1(G__39938) : outer.call(null,G__39938));
}));
...
var this$__$1 = this;
var G__39942 = cljs.core.with_meta(schema.core.named((function (){var G__39943 = this$__$1.schema;
return (inner.cljs$core$IFn$_invoke$arity$1 ? inner.cljs$core$IFn$_invoke$arity$1(G__39943) : inner.call(null,G__39943));
})(),this$__$1.name),cljs.core.meta(this$__$1));
return (outer.cljs$core$IFn$_invoke$arity$1 ? outer.cljs$core$IFn$_invoke$arity$1(G__39942) : outer.call(null,G__39942));
}));
...
var this$__$1 = this;
var G__39947 = cljs.core.with_meta(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(schema.core.either,cljs.core.map.cljs$core$IFn$_invoke$arity$2(inner,this$__$1.schemas)),cljs.core.meta(this$__$1));
return (outer.cljs$core$IFn$_invoke$arity$1 ? outer.cljs$core$IFn$_invoke$arity$1(G__39947) : outer.call(null,G__39947));
}));
...
var this$__$1 = this;
var G__39950 = cljs.core.with_meta(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(schema.core.cond_pre,cljs.core.map.cljs$core$IFn$_invoke$arity$2(inner,this$__$1.schemas)),cljs.core.meta(this$__$1));
return (outer.cljs$core$IFn$_invoke$arity$1 ? outer.cljs$core$IFn$_invoke$arity$1(G__39950) : outer.call(null,G__39950));
}));
...
var this$__$1 = this;
var G__39951 = cljs.core.with_meta(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(schema.core.both,cljs.core.map.cljs$core$IFn$_invoke$arity$2(inner,this$__$1.schemas)),cljs.core.meta(this$__$1));
return (outer.cljs$core$IFn$_invoke$arity$1 ? outer.cljs$core$IFn$_invoke$arity$1(G__39951) : outer.call(null,G__39951));
}));
...
var this$__$1 = this;
var G__39961 = cljs.core.with_meta(schema.core.constrained.cljs$core$IFn$_invoke$arity$3((function (){var G__39963 = this$__$1.schema;
return (inner.cljs$core$IFn$_invoke$arity$1 ? inner.cljs$core$IFn$_invoke$arity$1(G__39963) : inner.call(null,G__39963));
})(),this$__$1.postcondition,this$__$1.post_name),cljs.core.meta(this$__$1));
return (outer.cljs$core$IFn$_invoke$arity$1 ? outer.cljs$core$IFn$_invoke$arity$1(G__39961) : outer.call(null,G__39961));
}));
