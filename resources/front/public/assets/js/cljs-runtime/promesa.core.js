...
try{var G__32314_32700 = (function (p1__32301_SHARP_){
return promesa.protocols._resolve_BANG_(d,p1__32301_SHARP_);
});
var G__32315_32701 = (function (p1__32302_SHARP_){
return promesa.protocols._reject_BANG_(d,p1__32302_SHARP_);
});
(f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__32314_32700,G__32315_32701) : f.call(null,G__32314_32700,G__32315_32701));
}catch (e32313){var e_32702 = e32313;
promesa.protocols._reject_BANG_(d,e_32702);
}
return d;
}));
...
try{var G__32318 = (function (p1__32304_SHARP_){
return promesa.protocols._resolve_BANG_(d,p1__32304_SHARP_);
});
var G__32319 = (function (p1__32305_SHARP_){
return promesa.protocols._reject_BANG_(d,p1__32305_SHARP_);
});
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__32318,G__32319) : f.call(null,G__32318,G__32319));
}catch (e32316){var e = e32316;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__32356_SHARP_,p2__32357_SHARP_){
return promesa.core.then.cljs$core$IFn$_invoke$arity$2(p1__32356_SHARP_,p2__32357_SHARP_);
}),p,cljs.core.cons(f,fs));
}));

/** @this {Function} */
(promesa.core.chain.cljs$lang$applyTo = (function (seq32359){
var G__32360 = cljs.core.first(seq32359);
var seq32359__$1 = cljs.core.next(seq32359);
var G__32361 = cljs.core.first(seq32359__$1);
var seq32359__$2 = cljs.core.next(seq32359__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__32360,G__32361,seq32359__$2);
}));
...
/** @this {Function} */
(promesa.core.chain_SINGLEQUOTE_.cljs$lang$applyTo = (function (seq32364){
var G__32365 = cljs.core.first(seq32364);
var seq32364__$1 = cljs.core.next(seq32364);
var G__32366 = cljs.core.first(seq32364__$1);
var seq32364__$2 = cljs.core.next(seq32364__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__32365,G__32366,seq32364__$2);
}));
...
var accept_QMARK_ = ((cljs.core.ifn_QMARK_(pred_or_type))?pred_or_type:(function (p1__32411_SHARP_){
return (p1__32411_SHARP_ instanceof pred_or_type);
}));
...
var accept_QMARK_ = ((cljs.core.ifn_QMARK_(pred_or_type))?pred_or_type:(function (p1__32446_SHARP_){
return (p1__32446_SHARP_ instanceof pred_or_type);
}));
...
var seq__32532 = cljs.core.seq(promises);
var chunk__32533 = null;
var count__32534 = (0);
var i__32535 = (0);
while(true){
if((i__32535 < count__32534)){
var p = chunk__32533.cljs$core$IIndexed$_nth$arity$2(null,i__32535);
promesa.core.catch$.cljs$core$IFn$_invoke$arity$2(promesa.core.then.cljs$core$IFn$_invoke$arity$2(promesa.protocols._promise(p),((function (seq__32532,chunk__32533,count__32534,i__32535,p,state){
return (function (v){
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(state,((function (seq__32532,chunk__32533,count__32534,i__32535,p,state){
...
});})(seq__32532,chunk__32533,count__32534,i__32535,p,state))
);

return (resolve.cljs$core$IFn$_invoke$arity$1 ? resolve.cljs$core$IFn$_invoke$arity$1(v) : resolve.call(null,v));
}
});})(seq__32532,chunk__32533,count__32534,i__32535,p,state))
),((function (seq__32532,chunk__32533,count__32534,i__32535,p,state){
return (function (e){
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(state,((function (seq__32532,chunk__32533,count__32534,i__32535,p,state){
return (function (state__$1){
...
var map__32577 = cljs.core.deref(state);
var map__32577__$1 = cljs.core.__destructure_map(map__32577);
var resolved = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32577__$1,new cljs.core.Keyword(null,"resolved","resolved",968763567));
var counter = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32577__$1,new cljs.core.Keyword(null,"counter","counter",804008177));
var rejections = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32577__$1,new cljs.core.Keyword(null,"rejections","rejections",-1620899911));
...
var G__32579 = cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2("No promises resolved",new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"rejections","rejections",-1620899911),rejections], null));
return (reject.cljs$core$IFn$_invoke$arity$1 ? reject.cljs$core$IFn$_invoke$arity$1(G__32579) : reject.call(null,G__32579));
} else {
...
var G__32784 = seq__32532;
var G__32785 = chunk__32533;
var G__32786 = count__32534;
var G__32787 = (i__32535 + (1));
seq__32532 = G__32784;
chunk__32533 = G__32785;
count__32534 = G__32786;
i__32535 = G__32787;
continue;
} else {
var temp__5804__auto__ = cljs.core.seq(seq__32532);
if(temp__5804__auto__){
var seq__32532__$1 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__32532__$1)){
var c__5568__auto__ = cljs.core.chunk_first(seq__32532__$1);
var G__32789 = cljs.core.chunk_rest(seq__32532__$1);
var G__32790 = c__5568__auto__;
var G__32791 = cljs.core.count(c__5568__auto__);
var G__32792 = (0);
seq__32532 = G__32789;
chunk__32533 = G__32790;
count__32534 = G__32791;
i__32535 = G__32792;
continue;
} else {
var p = cljs.core.first(seq__32532__$1);
promesa.core.catch$.cljs$core$IFn$_invoke$arity$2(promesa.core.then.cljs$core$IFn$_invoke$arity$2(promesa.protocols._promise(p),((function (seq__32532,chunk__32533,count__32534,i__32535,p,seq__32532__$1,temp__5804__auto__,state){
return (function (v){
if(cljs.core.truth_(new cljs.core.Keyword(null,"resolved","resolved",968763567).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(state)))){
return null;
} else {
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(state,((function (seq__32532,chunk__32533,count__32534,i__32535,p,seq__32532__$1,temp__5804__auto__,state){
return (function (state__$1){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(state__$1,new cljs.core.Keyword(null,"resolved","resolved",968763567),true),new cljs.core.Keyword(null,"counter","counter",804008177),cljs.core.dec);
});})(seq__32532,chunk__32533,count__32534,i__32535,p,seq__32532__$1,temp__5804__auto__,state))
);

return (resolve.cljs$core$IFn$_invoke$arity$1 ? resolve.cljs$core$IFn$_invoke$arity$1(v) : resolve.call(null,v));
}
});})(seq__32532,chunk__32533,count__32534,i__32535,p,seq__32532__$1,temp__5804__auto__,state))
),((function (seq__32532,chunk__32533,count__32534,i__32535,p,seq__32532__$1,temp__5804__auto__,state){
return (function (e){
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(state,((function (seq__32532,chunk__32533,count__32534,i__32535,p,seq__32532__$1,temp__5804__auto__,state){
return (function (state__$1){
return cljs.core.update.cljs$core$IFn$_invoke$arity$4(cljs.core.update.cljs$core$IFn$_invoke$arity$3(state__$1,new cljs.core.Keyword(null,"counter","counter",804008177),cljs.core.dec),new cljs.core.Keyword(null,"rejections","rejections",-1620899911),cljs.core.conj,e);
...
var map__32588 = cljs.core.deref(state);
var map__32588__$1 = cljs.core.__destructure_map(map__32588);
var resolved = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32588__$1,new cljs.core.Keyword(null,"resolved","resolved",968763567));
var counter = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32588__$1,new cljs.core.Keyword(null,"counter","counter",804008177));
var rejections = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32588__$1,new cljs.core.Keyword(null,"rejections","rejections",-1620899911));
if(((cljs.core.not(resolved)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(counter,(0))))){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(default$,new cljs.core.Keyword("promesa.core","default","promesa.core/default",1773193826))){
var G__32596 = cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2("No promises resolved",new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"rejections","rejections",-1620899911),rejections], null));
return (reject.cljs$core$IFn$_invoke$arity$1 ? reject.cljs$core$IFn$_invoke$arity$1(G__32596) : reject.call(null,G__32596));
} else {
return (resolve.cljs$core$IFn$_invoke$arity$1 ? resolve.cljs$core$IFn$_invoke$arity$1(default$) : resolve.call(null,default$));
}
} else {
...
var G__32795 = cljs.core.next(seq__32532__$1);
var G__32796 = null;
var G__32797 = (0);
var G__32798 = (0);
seq__32532 = G__32795;
chunk__32533 = G__32796;
count__32534 = G__32797;
i__32535 = G__32798;
continue;
}
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__32597_SHARP_,p2__32598_SHARP_){
return promesa.core.then.cljs$core$IFn$_invoke$arity$2(p1__32597_SHARP_,(function (_){
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(p2__32598_SHARP_) : f.call(null,p2__32598_SHARP_));
}));
...
return (function() { 
var G__32801__delegate = function (args){
return promesa.core.create.cljs$core$IFn$_invoke$arity$1((function (resolve,reject){
...
while (G__32802__i < G__32802__a.length) {G__32802__a[G__32802__i] = arguments[G__32802__i + 0]; ++G__32802__i;}
  args = new cljs.core.IndexedSeq(G__32802__a,0,null);
} 
return G__32801__delegate.call(this,args);};
G__32801.cljs$lang$maxFixedArity = 0;
G__32801.cljs$lang$applyTo = (function (arglist__32807){
var args = cljs.core.seq(arglist__32807);
