...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_27861 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_27861(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_27862 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_27862(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_27863 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_27863(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_27864 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_27864(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_27865 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_27865(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_27866 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_27866(reader);
}
});
...
var G__27883 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__27884 = s.append(c);
c = G__27883;
s = G__27884;
continue;
}
