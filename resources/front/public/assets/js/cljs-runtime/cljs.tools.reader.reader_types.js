...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_21243 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_21243(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_21251 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_21251(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_21266 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_21266(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_21276 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_21276(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_21277 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_21277(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_21281 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_21281(reader);
}
});
...
var G__21353 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__21354 = s.append(c);
c = G__21353;
s = G__21354;
continue;
}
