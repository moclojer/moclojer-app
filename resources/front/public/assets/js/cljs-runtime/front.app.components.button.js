...
front.app.components.button.props__GT_classes = (function front$app$components$button$props__GT_classes(p__27081){
var map__27082 = p__27081;
var map__27082__$1 = cljs.core.__destructure_map(map__27082);
var variant = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__27082__$1,new cljs.core.Keyword(null,"variant","variant",-424354234),new cljs.core.Keyword(null,"solid","solid",-2023773691));
var color = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__27082__$1,new cljs.core.Keyword(null,"color","color",1011675173),new cljs.core.Keyword(null,"blue","blue",-622100620));
var class_name = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__27082__$1,new cljs.core.Keyword(null,"class-name","class-name",945142584),"");
...
if(goog.DEBUG){
front.app.components.button.sig27083 = helix.core.signature_BANG_();
} else {
}

front.app.components.button.Button = (function (){var G__27085 = (function front$app$components$button$Button_render(props__24071__auto__,maybe_ref__24072__auto__){
var vec__27091 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [helix.core.extract_cljs_props(props__24071__auto__),maybe_ref__24072__auto__], null);
var map__27094 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27091,(0),null);
var map__27094__$1 = cljs.core.__destructure_map(map__27094);
var props = map__27094__$1;
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27094__$1,new cljs.core.Keyword(null,"children","children",-940561982));
if(cljs.core.truth_(goog.DEBUG)){
if(cljs.core.truth_(front.app.components.button.sig27083)){
(front.app.components.button.sig27083.cljs$core$IFn$_invoke$arity$0 ? front.app.components.button.sig27083.cljs$core$IFn$_invoke$arity$0() : front.app.components.button.sig27083.call(null));
} else {
}
} else {
}
...
return helix.core.get_react().createElement("button",helix.impl.props.merge_obj((function (){var obj27115 = ({"className":classes});
return obj27115;
...
if(goog.DEBUG === true){
var G__27121 = G__27085;
(G__27121.displayName = "front.app.components.button/Button");
...
if(cljs.core.truth_(front.app.components.button.sig27083)){
(front.app.components.button.sig27083.cljs$core$IFn$_invoke$arity$4 ? front.app.components.button.sig27083.cljs$core$IFn$_invoke$arity$4(front.app.components.button.Button,"",null,null) : front.app.components.button.sig27083.call(null,front.app.components.button.Button,"",null,null));
} else {
}
