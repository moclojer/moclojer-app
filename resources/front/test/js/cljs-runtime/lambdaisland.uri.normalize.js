...
var G__51684 = next_offset;
var G__51685 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(res,cur_char);
offset__$1 = G__51684;
res = G__51685;
continue;
}
...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__51560_SHARP_){
return ["%",lambdaisland.uri.platform.byte__GT_hex(p1__51560_SHARP_)].join('');
...
var encode_char = (function (p1__51561_SHARP_){
var G__51567 = p1__51561_SHARP_;
if(cljs.core.truth_(cljs.core.re_find(char_class,p1__51561_SHARP_))){
return lambdaisland.uri.normalize.percent_encode.cljs$core$IFn$_invoke$arity$1(G__51567);
} else {
return G__51567;
}
});
...
return clojure.string.replace(s,/(%[0-9A-Fa-f]{2})+/,(function (p__51578){
var vec__51580 = p__51578;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51580,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51580,(1),null);
...
var G__51724 = (i + (3));
var G__51726 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(res,lambdaisland.uri.normalize.percent_encode.cljs$core$IFn$_invoke$arity$2(lambdaisland.uri.normalize.percent_decode(cljs.core.subs.cljs$core$IFn$_invoke$arity$3(s,i,(i + (3)))),new cljs.core.Keyword(null,"query","query",-1288509510)));
i = G__51724;
res = G__51726;
continue;
} else {
...
var G__51727 = (i + (1));
var G__51728 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(res,cljs.core.subs.cljs$core$IFn$_invoke$arity$3(s,i,(i + (1))));
i = G__51727;
res = G__51728;
continue;
} else {
var increment = ((lambdaisland.uri.normalize.high_surrogate_QMARK_(lambdaisland.uri.platform.char_code_at(s,i)))?(2):(1));
var G__51741 = (i + increment);
var G__51742 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(res,lambdaisland.uri.normalize.percent_encode.cljs$core$IFn$_invoke$arity$2(cljs.core.subs.cljs$core$IFn$_invoke$arity$3(s,i,(i + increment)),new cljs.core.Keyword(null,"query","query",-1288509510)));
i = G__51741;
res = G__51742;
continue;
