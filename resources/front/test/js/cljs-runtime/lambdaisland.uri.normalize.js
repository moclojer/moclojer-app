...
var G__57147 = next_offset;
var G__57148 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(res,cur_char);
offset__$1 = G__57147;
res = G__57148;
continue;
}
...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57036_SHARP_){
return ["%",lambdaisland.uri.platform.byte__GT_hex(p1__57036_SHARP_)].join('');
...
var encode_char = (function (p1__57037_SHARP_){
var G__57040 = p1__57037_SHARP_;
if(cljs.core.truth_(cljs.core.re_find(char_class,p1__57037_SHARP_))){
return lambdaisland.uri.normalize.percent_encode.cljs$core$IFn$_invoke$arity$1(G__57040);
} else {
return G__57040;
}
});
...
return clojure.string.replace(s,/(%[0-9A-Fa-f]{2})+/,(function (p__57042){
var vec__57043 = p__57042;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57043,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57043,(1),null);
...
var G__57164 = (i + (3));
var G__57165 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(res,lambdaisland.uri.normalize.percent_encode.cljs$core$IFn$_invoke$arity$2(lambdaisland.uri.normalize.percent_decode(cljs.core.subs.cljs$core$IFn$_invoke$arity$3(s,i,(i + (3)))),new cljs.core.Keyword(null,"query","query",-1288509510)));
i = G__57164;
res = G__57165;
continue;
} else {
...
var G__57168 = (i + (1));
var G__57169 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(res,cljs.core.subs.cljs$core$IFn$_invoke$arity$3(s,i,(i + (1))));
i = G__57168;
res = G__57169;
continue;
} else {
var increment = ((lambdaisland.uri.normalize.high_surrogate_QMARK_(lambdaisland.uri.platform.char_code_at(s,i)))?(2):(1));
var G__57177 = (i + increment);
var G__57178 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(res,lambdaisland.uri.normalize.percent_encode.cljs$core$IFn$_invoke$arity$2(cljs.core.subs.cljs$core$IFn$_invoke$arity$3(s,i,(i + increment)),new cljs.core.Keyword(null,"query","query",-1288509510)));
i = G__57177;
res = G__57178;
continue;
