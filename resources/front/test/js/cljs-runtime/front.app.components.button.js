...
front.app.components.button.props__GT_classes = (function front$app$components$button$props__GT_classes(p__62138){
var map__62139 = p__62138;
var map__62139__$1 = cljs.core.__destructure_map(map__62139);
var variant = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__62139__$1,new cljs.core.Keyword(null,"variant","variant",-424354234),new cljs.core.Keyword(null,"solid","solid",-2023773691));
var color = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__62139__$1,new cljs.core.Keyword(null,"color","color",1011675173),new cljs.core.Keyword(null,"blue","blue",-622100620));
var class_name = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__62139__$1,new cljs.core.Keyword(null,"class-name","class-name",945142584),"");
...
if(goog.DEBUG){
front.app.components.button.sig62147 = helix.core.signature_BANG_();
} else {
}

front.app.components.button.Button = (function (){var G__62150 = (function front$app$components$button$Button_render(props__32635__auto__,maybe_ref__32636__auto__){
var vec__62151 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [helix.core.extract_cljs_props(props__32635__auto__),maybe_ref__32636__auto__], null);
var map__62154 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62151,(0),null);
var map__62154__$1 = cljs.core.__destructure_map(map__62154);
var props = map__62154__$1;
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62154__$1,new cljs.core.Keyword(null,"children","children",-940561982));
if(cljs.core.truth_(goog.DEBUG)){
if(cljs.core.truth_(front.app.components.button.sig62147)){
(front.app.components.button.sig62147.cljs$core$IFn$_invoke$arity$0 ? front.app.components.button.sig62147.cljs$core$IFn$_invoke$arity$0() : front.app.components.button.sig62147.call(null));
} else {
}
} else {
}
...
return helix.core.get_react().createElement("button",helix.impl.props.merge_obj((function (){var obj62161 = ({"className":classes});
return obj62161;
...
if(goog.DEBUG === true){
var G__62162 = G__62150;
(G__62162.displayName = "front.app.components.button/Button");
...
if(cljs.core.truth_(front.app.components.button.sig62147)){
(front.app.components.button.sig62147.cljs$core$IFn$_invoke$arity$4 ? front.app.components.button.sig62147.cljs$core$IFn$_invoke$arity$4(front.app.components.button.Button,"",null,null) : front.app.components.button.sig62147.call(null,front.app.components.button.Button,"",null,null));
} else {
}
