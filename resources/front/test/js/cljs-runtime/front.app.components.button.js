...
front.app.components.button.props__GT_classes = (function front$app$components$button$props__GT_classes(p__53497){
var map__53498 = p__53497;
var map__53498__$1 = cljs.core.__destructure_map(map__53498);
var variant = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__53498__$1,new cljs.core.Keyword(null,"variant","variant",-424354234),new cljs.core.Keyword(null,"solid","solid",-2023773691));
var color = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__53498__$1,new cljs.core.Keyword(null,"color","color",1011675173),new cljs.core.Keyword(null,"blue","blue",-622100620));
var class_name = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__53498__$1,new cljs.core.Keyword(null,"class-name","class-name",945142584),"");
...
if(goog.DEBUG){
front.app.components.button.sig53501 = helix.core.signature_BANG_();
} else {
}

front.app.components.button.Button = (function (){var G__53502 = (function front$app$components$button$Button_render(props__27103__auto__,maybe_ref__27104__auto__){
var vec__53506 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [helix.core.extract_cljs_props(props__27103__auto__),maybe_ref__27104__auto__], null);
var map__53511 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53506,(0),null);
var map__53511__$1 = cljs.core.__destructure_map(map__53511);
var props = map__53511__$1;
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53511__$1,new cljs.core.Keyword(null,"children","children",-940561982));
if(cljs.core.truth_(goog.DEBUG)){
if(cljs.core.truth_(front.app.components.button.sig53501)){
(front.app.components.button.sig53501.cljs$core$IFn$_invoke$arity$0 ? front.app.components.button.sig53501.cljs$core$IFn$_invoke$arity$0() : front.app.components.button.sig53501.call(null));
} else {
}
} else {
}
...
return helix.core.get_react().createElement("button",helix.impl.props.merge_obj((function (){var obj53525 = ({"className":classes});
return obj53525;
...
if(goog.DEBUG === true){
var G__53533 = G__53502;
(G__53533.displayName = "front.app.components.button/Button");
...
if(cljs.core.truth_(front.app.components.button.sig53501)){
(front.app.components.button.sig53501.cljs$core$IFn$_invoke$arity$4 ? front.app.components.button.sig53501.cljs$core$IFn$_invoke$arity$4(front.app.components.button.Button,"",null,null) : front.app.components.button.sig53501.call(null,front.app.components.button.Button,"",null,null));
} else {
}
