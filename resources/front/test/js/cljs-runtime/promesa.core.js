...
try{var G__52480_52637 = (function (p1__52440_SHARP_){
return promesa.protocols._resolve_BANG_(d,p1__52440_SHARP_);
});
var G__52481_52638 = (function (p1__52441_SHARP_){
return promesa.protocols._reject_BANG_(d,p1__52441_SHARP_);
});
(f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__52480_52637,G__52481_52638) : f.call(null,G__52480_52637,G__52481_52638));
}catch (e52479){var e_52648 = e52479;
promesa.protocols._reject_BANG_(d,e_52648);
}
return d;
}));
...
try{var G__52483 = (function (p1__52447_SHARP_){
return promesa.protocols._resolve_BANG_(d,p1__52447_SHARP_);
});
var G__52484 = (function (p1__52448_SHARP_){
return promesa.protocols._reject_BANG_(d,p1__52448_SHARP_);
});
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__52483,G__52484) : f.call(null,G__52483,G__52484));
}catch (e52482){var e = e52482;
...
var i__5770__auto___52662 = (0);
while(true){
if((i__5770__auto___52662 < len__5769__auto___52657)){
args_arr__5794__auto__.push((arguments[i__5770__auto___52662]));

var G__52663 = (i__5770__auto___52662 + (1));
i__5770__auto___52662 = G__52663;
continue;
} else {
}
break;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__52549_SHARP_,p2__52550_SHARP_){
return promesa.core.then.cljs$core$IFn$_invoke$arity$2(p1__52549_SHARP_,p2__52550_SHARP_);
}),p,cljs.core.cons(f,fs));
}));

/** @this {Function} */
(promesa.core.chain.cljs$lang$applyTo = (function (seq52553){
var G__52554 = cljs.core.first(seq52553);
var seq52553__$1 = cljs.core.next(seq52553);
var G__52555 = cljs.core.first(seq52553__$1);
var seq52553__$2 = cljs.core.next(seq52553__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__52554,G__52555,seq52553__$2);
}));
...
/** @this {Function} */
(promesa.core.chain_SINGLEQUOTE_.cljs$lang$applyTo = (function (seq52571){
var G__52572 = cljs.core.first(seq52571);
var seq52571__$1 = cljs.core.next(seq52571);
var G__52573 = cljs.core.first(seq52571__$1);
var seq52571__$2 = cljs.core.next(seq52571__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__52572,G__52573,seq52571__$2);
}));
...
var accept_QMARK_ = ((cljs.core.ifn_QMARK_(pred_or_type))?pred_or_type:(function (p1__52581_SHARP_){
return (p1__52581_SHARP_ instanceof pred_or_type);
}));
...
var accept_QMARK_ = ((cljs.core.ifn_QMARK_(pred_or_type))?pred_or_type:(function (p1__52585_SHARP_){
return (p1__52585_SHARP_ instanceof pred_or_type);
}));
...
var seq__52592 = cljs.core.seq(promises);
var chunk__52593 = null;
var count__52594 = (0);
var i__52595 = (0);
while(true){
if((i__52595 < count__52594)){
var p = chunk__52593.cljs$core$IIndexed$_nth$arity$2(null,i__52595);
promesa.core.catch$.cljs$core$IFn$_invoke$arity$2(promesa.core.then.cljs$core$IFn$_invoke$arity$2(promesa.protocols._promise(p),((function (seq__52592,chunk__52593,count__52594,i__52595,p,state){
return (function (v){
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(state,((function (seq__52592,chunk__52593,count__52594,i__52595,p,state){
...
});})(seq__52592,chunk__52593,count__52594,i__52595,p,state))
);

return (resolve.cljs$core$IFn$_invoke$arity$1 ? resolve.cljs$core$IFn$_invoke$arity$1(v) : resolve.call(null,v));
}
});})(seq__52592,chunk__52593,count__52594,i__52595,p,state))
),((function (seq__52592,chunk__52593,count__52594,i__52595,p,state){
return (function (e){
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(state,((function (seq__52592,chunk__52593,count__52594,i__52595,p,state){
return (function (state__$1){
...
var map__52602 = cljs.core.deref(state);
var map__52602__$1 = cljs.core.__destructure_map(map__52602);
var resolved = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52602__$1,new cljs.core.Keyword(null,"resolved","resolved",968763567));
var counter = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52602__$1,new cljs.core.Keyword(null,"counter","counter",804008177));
var rejections = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52602__$1,new cljs.core.Keyword(null,"rejections","rejections",-1620899911));
...
var G__52603 = cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2("No promises resolved",new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"rejections","rejections",-1620899911),rejections], null));
return (reject.cljs$core$IFn$_invoke$arity$1 ? reject.cljs$core$IFn$_invoke$arity$1(G__52603) : reject.call(null,G__52603));
} else {
...
var G__52685 = seq__52592;
var G__52686 = chunk__52593;
var G__52687 = count__52594;
var G__52688 = (i__52595 + (1));
seq__52592 = G__52685;
chunk__52593 = G__52686;
count__52594 = G__52687;
i__52595 = G__52688;
continue;
} else {
var temp__5804__auto__ = cljs.core.seq(seq__52592);
if(temp__5804__auto__){
var seq__52592__$1 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__52592__$1)){
var c__5568__auto__ = cljs.core.chunk_first(seq__52592__$1);
var G__52689 = cljs.core.chunk_rest(seq__52592__$1);
var G__52690 = c__5568__auto__;
var G__52691 = cljs.core.count(c__5568__auto__);
var G__52692 = (0);
seq__52592 = G__52689;
chunk__52593 = G__52690;
count__52594 = G__52691;
i__52595 = G__52692;
continue;
} else {
var p = cljs.core.first(seq__52592__$1);
promesa.core.catch$.cljs$core$IFn$_invoke$arity$2(promesa.core.then.cljs$core$IFn$_invoke$arity$2(promesa.protocols._promise(p),((function (seq__52592,chunk__52593,count__52594,i__52595,p,seq__52592__$1,temp__5804__auto__,state){
return (function (v){
if(cljs.core.truth_(new cljs.core.Keyword(null,"resolved","resolved",968763567).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(state)))){
return null;
} else {
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(state,((function (seq__52592,chunk__52593,count__52594,i__52595,p,seq__52592__$1,temp__5804__auto__,state){
return (function (state__$1){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(state__$1,new cljs.core.Keyword(null,"resolved","resolved",968763567),true),new cljs.core.Keyword(null,"counter","counter",804008177),cljs.core.dec);
});})(seq__52592,chunk__52593,count__52594,i__52595,p,seq__52592__$1,temp__5804__auto__,state))
);

return (resolve.cljs$core$IFn$_invoke$arity$1 ? resolve.cljs$core$IFn$_invoke$arity$1(v) : resolve.call(null,v));
}
});})(seq__52592,chunk__52593,count__52594,i__52595,p,seq__52592__$1,temp__5804__auto__,state))
),((function (seq__52592,chunk__52593,count__52594,i__52595,p,seq__52592__$1,temp__5804__auto__,state){
return (function (e){
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(state,((function (seq__52592,chunk__52593,count__52594,i__52595,p,seq__52592__$1,temp__5804__auto__,state){
return (function (state__$1){
return cljs.core.update.cljs$core$IFn$_invoke$arity$4(cljs.core.update.cljs$core$IFn$_invoke$arity$3(state__$1,new cljs.core.Keyword(null,"counter","counter",804008177),cljs.core.dec),new cljs.core.Keyword(null,"rejections","rejections",-1620899911),cljs.core.conj,e);
...
var map__52607 = cljs.core.deref(state);
var map__52607__$1 = cljs.core.__destructure_map(map__52607);
var resolved = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52607__$1,new cljs.core.Keyword(null,"resolved","resolved",968763567));
var counter = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52607__$1,new cljs.core.Keyword(null,"counter","counter",804008177));
var rejections = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52607__$1,new cljs.core.Keyword(null,"rejections","rejections",-1620899911));
if(((cljs.core.not(resolved)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(counter,(0))))){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(default$,new cljs.core.Keyword("promesa.core","default","promesa.core/default",1773193826))){
var G__52608 = cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2("No promises resolved",new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"rejections","rejections",-1620899911),rejections], null));
return (reject.cljs$core$IFn$_invoke$arity$1 ? reject.cljs$core$IFn$_invoke$arity$1(G__52608) : reject.call(null,G__52608));
} else {
return (resolve.cljs$core$IFn$_invoke$arity$1 ? resolve.cljs$core$IFn$_invoke$arity$1(default$) : resolve.call(null,default$));
}
} else {
...
var G__52703 = cljs.core.next(seq__52592__$1);
var G__52704 = null;
var G__52705 = (0);
var G__52706 = (0);
seq__52592 = G__52703;
chunk__52593 = G__52704;
count__52594 = G__52705;
i__52595 = G__52706;
continue;
}
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__52609_SHARP_,p2__52610_SHARP_){
return promesa.core.then.cljs$core$IFn$_invoke$arity$2(p1__52609_SHARP_,(function (_){
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(p2__52610_SHARP_) : f.call(null,p2__52610_SHARP_));
}));
...
}catch (e52615){if((e52615 instanceof Error)){
var e = e52615;
