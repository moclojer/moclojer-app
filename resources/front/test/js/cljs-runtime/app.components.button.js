...
app.components.button.props__GT_classes = (function app$components$button$props__GT_classes(p__33280){
var map__33281 = p__33280;
var map__33281__$1 = cljs.core.__destructure_map(map__33281);
var variant = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__33281__$1,new cljs.core.Keyword(null,"variant","variant",-424354234),new cljs.core.Keyword(null,"solid","solid",-2023773691));
var color = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__33281__$1,new cljs.core.Keyword(null,"color","color",1011675173),new cljs.core.Keyword(null,"blue","blue",-622100620));
var class_name = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__33281__$1,new cljs.core.Keyword(null,"class-name","class-name",945142584),"");
...
if(goog.DEBUG){
app.components.button.sig33284 = helix.core.signature_BANG_();
} else {
}

app.components.button.Button = (function (){var G__33285 = (function app$components$button$Button_render(props__27104__auto__,maybe_ref__27105__auto__){
var vec__33293 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [helix.core.extract_cljs_props(props__27104__auto__),maybe_ref__27105__auto__], null);
var map__33296 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33293,(0),null);
var map__33296__$1 = cljs.core.__destructure_map(map__33296);
var props = map__33296__$1;
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33296__$1,new cljs.core.Keyword(null,"children","children",-940561982));
if(cljs.core.truth_(goog.DEBUG)){
if(cljs.core.truth_(app.components.button.sig33284)){
(app.components.button.sig33284.cljs$core$IFn$_invoke$arity$0 ? app.components.button.sig33284.cljs$core$IFn$_invoke$arity$0() : app.components.button.sig33284.call(null));
} else {
}
} else {
}
...
return helix.core.get_react().createElement("button",helix.impl.props.merge_obj((function (){var obj33300 = ({"className":classes});
return obj33300;
...
if(goog.DEBUG === true){
var G__33302 = G__33285;
(G__33302.displayName = "app.components.button/Button");
...
if(cljs.core.truth_(app.components.button.sig33284)){
(app.components.button.sig33284.cljs$core$IFn$_invoke$arity$4 ? app.components.button.sig33284.cljs$core$IFn$_invoke$arity$4(app.components.button.Button,"",null,null) : app.components.button.sig33284.call(null,app.components.button.Button,"",null,null));
} else {
}
