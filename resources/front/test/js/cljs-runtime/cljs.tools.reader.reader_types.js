...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_43689 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_43689(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_43692 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_43692(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_43693 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_43693(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_43698 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_43698(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_43703 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_43703(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_43707 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_43707(reader);
}
});
...
var G__43766 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__43767 = s.append(c);
c = G__43766;
s = G__43767;
continue;
}
