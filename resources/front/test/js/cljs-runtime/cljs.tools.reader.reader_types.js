...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_49264 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_49264(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_49265 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_49265(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_49266 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_49266(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_49269 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_49269(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_49271 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_49271(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_49272 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_49272(reader);
}
});
...
var G__49299 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__49300 = s.append(c);
c = G__49299;
s = G__49300;
continue;
}
