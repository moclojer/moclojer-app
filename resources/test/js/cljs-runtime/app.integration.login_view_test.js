...
try{if((typeof app !== 'undefined') && (typeof app.integration !== 'undefined') && (typeof app.integration.login_view_test !== 'undefined') && (typeof app.integration.login_view_test.t_app$integration$login_view_test33338 !== 'undefined')){
} else {
...
*/
app.integration.login_view_test.t_app$integration$login_view_test33338 = (function (meta33339){
this.meta33339 = meta33339;
this.cljs$lang$protocol_mask$partition0$ = 393217;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(app.integration.login_view_test.t_app$integration$login_view_test33338.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_33340,meta33339__$1){
var self__ = this;
var _33340__$1 = this;
return (new app.integration.login_view_test.t_app$integration$login_view_test33338(meta33339__$1));
}));

(app.integration.login_view_test.t_app$integration$login_view_test33338.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_33340){
var self__ = this;
var _33340__$1 = this;
return self__.meta33339;
}));

(app.integration.login_view_test.t_app$integration$login_view_test33338.prototype.cljs$test$IAsyncTest$ = cljs.core.PROTOCOL_SENTINEL);

(app.integration.login_view_test.t_app$integration$login_view_test33338.prototype.call = (function (unused__11778__auto__){
var self__ = this;
var self__ = this;
var G__33345 = (arguments.length - (1));
switch (G__33345) {
case (1):
...
(app.integration.login_view_test.t_app$integration$login_view_test33338.prototype.apply = (function (self__,args33341){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args33341)));
}));

(app.integration.login_view_test.t_app$integration$login_view_test33338.prototype.cljs$core$IFn$_invoke$arity$1 = (function (done){
var self__ = this;
...
}catch (e33349){var t__11406__auto__ = e33349;
...
(app.integration.login_view_test.t_app$integration$login_view_test33338.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta33339","meta33339",-2089071992,null)], null);
}));

(app.integration.login_view_test.t_app$integration$login_view_test33338.cljs$lang$type = true);

(app.integration.login_view_test.t_app$integration$login_view_test33338.cljs$lang$ctorStr = "app.integration.login-view-test/t_app$integration$login_view_test33338");

(app.integration.login_view_test.t_app$integration$login_view_test33338.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"app.integration.login-view-test/t_app$integration$login_view_test33338");
}));

/**
 * Positional factory function for app.integration.login-view-test/t_app$integration$login_view_test33338.
 */
app.integration.login_view_test.__GT_t_app$integration$login_view_test33338 = (function app$integration$login_view_test$__GT_t_app$integration$login_view_test33338(meta33339){
return (new app.integration.login_view_test.t_app$integration$login_view_test33338(meta33339));
});

}

return (new app.integration.login_view_test.t_app$integration$login_view_test33338(null));
...
try{if((typeof app !== 'undefined') && (typeof app.integration !== 'undefined') && (typeof app.integration.login_view_test !== 'undefined') && (typeof app.integration.login_view_test.t_app$integration$login_view_test33353 !== 'undefined')){
} else {
 ...
 * @implements {cljs.core.IWithMeta}
*/
app.integration.login_view_test.t_app$integration$login_view_test33353 = (function (meta33354){
this.meta33354 = meta33354;
this.cljs$lang$protocol_mask$partition0$ = 393217;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(app.integration.login_view_test.t_app$integration$login_view_test33353.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_33355,meta33354__$1){
var self__ = this;
var _33355__$1 = this;
return (new app.integration.login_view_test.t_app$integration$login_view_test33353(meta33354__$1));
}));

(app.integration.login_view_test.t_app$integration$login_view_test33353.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_33355){
var self__ = this;
var _33355__$1 = this;
return self__.meta33354;
}));

(app.integration.login_view_test.t_app$integration$login_view_test33353.prototype.cljs$test$IAsyncTest$ = cljs.core.PROTOCOL_SENTINEL);

(app.integration.login_view_test.t_app$integration$login_view_test33353.prototype.call = (function (unused__11778__auto__){
var self__ = this;
var self__ = this;
var G__33358 = (arguments.length - (1));
switch (G__33358) {
case (1):
return self__.cljs$core$IFn$_invoke$arity$1((arguments[(1)]));
...
(app.integration.login_view_test.t_app$integration$login_view_test33353.prototype.apply = (function (self__,args33357){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args33357)));
}));

(app.integration.login_view_test.t_app$integration$login_view_test33353.prototype.cljs$core$IFn$_invoke$arity$1 = (function (done){
var self__ = this;
var ___11437__auto__ = this;
return promesa.protocols._bind(promesa.protocols._promise(null),(function (___28044__auto__){
...
return result__11356__auto__;
}catch (e33361){var t__11406__auto__ = e33361;
...
(app.integration.login_view_test.t_app$integration$login_view_test33353.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta33354","meta33354",2119051037,null)], null);
}));

(app.integration.login_view_test.t_app$integration$login_view_test33353.cljs$lang$type = true);

(app.integration.login_view_test.t_app$integration$login_view_test33353.cljs$lang$ctorStr = "app.integration.login-view-test/t_app$integration$login_view_test33353");

(app.integration.login_view_test.t_app$integration$login_view_test33353.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"app.integration.login-view-test/t_app$integration$login_view_test33353");
}));

/**
 * Positional factory function for app.integration.login-view-test/t_app$integration$login_view_test33353.
 */
app.integration.login_view_test.__GT_t_app$integration$login_view_test33353 = (function app$integration$login_view_test$__GT_t_app$integration$login_view_test33353(meta33354){
return (new app.integration.login_view_test.t_app$integration$login_view_test33353(meta33354));
});

}

return (new app.integration.login_view_test.t_app$integration$login_view_test33353(null));
}finally {cljs.test.update_current_env_BANG_(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523)], null),cljs.core.rest);
}});
