...
var make_chain = (function (p1__49490_SHARP_){
return cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.flatten(p1__49490_SHARP_));
});
...
var temp__5804__auto___49496 = cljs.core.first(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(refx.interceptor.interceptor_QMARK_,chain));
if(cljs.core.truth_(temp__5804__auto___49496)){
var not_i_49497 = temp__5804__auto___49496;
refx.log.error.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["when registering",id,", expected interceptors, but got:",not_i_49497], 0));
} else {
}
...
var temp__5804__auto__ = refx.registry.lookup.cljs$core$IFn$_invoke$arity$2(refx.events.kind,event_id);
if(cljs.core.truth_(temp__5804__auto__)){
var interceptors = temp__5804__auto__;
...
var _STAR_handling_STAR__orig_val__49492 = refx.events._STAR_handling_STAR_;
var _STAR_handling_STAR__temp_val__49493 = event_v;
(refx.events._STAR_handling_STAR_ = _STAR_handling_STAR__temp_val__49493);

try{return refx.interceptor.execute(event_v,interceptors);
}finally {(refx.events._STAR_handling_STAR_ = _STAR_handling_STAR__orig_val__49492);
}}
} else {
return null;
}
...
var map__49494 = refx.interceptor.get_coeffect.cljs$core$IFn$_invoke$arity$1(context);
var map__49494__$1 = cljs.core.__destructure_map(map__49494);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49494__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49494__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__49495 = refx.interceptor.get_coeffect.cljs$core$IFn$_invoke$arity$1(context);
var map__49495__$1 = cljs.core.__destructure_map(map__49495);
var coeffects = map__49495__$1;
var event = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49495__$1,new cljs.core.Keyword(null,"event","event",301435442));
