...
null}function getCurrentFiberStackInDev(){return null===current$jscomp$2?"":getStackByFiberInDevAndProd(current$jscomp$2)}function resetCurrentFiber(){current$jscomp$2=ReactDebugCurrentFrame.getCurrentStack=null;isRendering=!1}function setCurrentFiber(fiber){ReactDebugCurrentFrame.getCurrentStack=null===fiber?null:getCurrentFiberStackInDev;current$jscomp$2=fiber;isRendering=!1}function getToStringValue(value){switch(typeof value){case "boolean":case "number":case "string":case "undefined":return value;
