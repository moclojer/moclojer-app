...
var i_40796 = (0);
while(true){
if((i_40796 < arr.length)){
(arr[i_40796] = null);

var G__40797 = (i_40796 + (1));
i_40796 = G__40797;
continue;
} else {
}
...
var i_40808 = (self__.level + (1));
while(true){
if((i_40808 <= (new_level + (1)))){
(update[i_40808] = self__.header);

var G__40809 = (i_40808 + (1));
i_40808 = G__40809;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_40810 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_40810[i]));
} else {
x__$2.forward.push((((i < links_40810.length))?(links_40810[i]):null));
}

if((i < links_40810.length)){
(links_40810[i] = x__$2);
} else {
links_40810.push(x__$2);
}
...
var i_40814 = (0);
while(true){
if((i_40814 <= self__.level)){
var links_40815 = (update[i_40814]).forward;
if((x__$1 === (((i_40814 < links_40815.length))?(links_40815[i_40814]):null))){
(links_40815[i_40814] = (x__$1.forward[i_40814]));

var G__40817 = (i_40814 + (1));
i_40814 = G__40817;
continue;
} else {
var G__40818 = (i_40814 + (1));
i_40814 = G__40818;
continue;
}
} else {
...
var G__40825 = nx;
var G__40826 = (level__$1 - (1));
x = G__40825;
level__$1 = G__40826;
continue;
} else {
var G__40827 = x;
var G__40828 = (level__$1 - (1));
x = G__40827;
level__$1 = G__40828;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__40834 = nx;
var G__40835 = (level__$1 - (1));
x = G__40834;
level__$1 = G__40835;
continue;
} else {
var G__40836 = x;
var G__40837 = (level__$1 - (1));
x = G__40836;
level__$1 = G__40837;
continue;
}
