...
return name_str.replace(helix.impl.props.camel_regexp,(function (p1__50162_SHARP_,p2__50161_SHARP_){
return p2__50161_SHARP_.toUpperCase();
}));
...
var G__50163 = o;
helix.impl.props.goog$module$goog$object.set(G__50163,k,v);
...
while(true){
if(cljs.core.seq(m)){
var G__50209 = cljs.core.rest(m);
var G__50210 = (function (){var entry = cljs.core.first(m);
...
var G__50174 = o1;
helix.impl.props.goog$module$goog$object.extend(G__50174,o2);
...
return helix.impl.props.into_js_array(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__50181_SHARP_){
if(cljs.core.map_QMARK_(p1__50181_SHARP_)){
return helix.impl.props.primitive_obj.cljs$core$IFn$_invoke$arity$1(p1__50181_SHARP_);
} else {
return p1__50181_SHARP_;
}
}),style));
} else {
return style;
...
while(true){
if(cljs.core.seq(m)){
var G__50212 = cljs.core.rest(m);
var G__50213 = (function (){var entry = cljs.core.first(m);
...
while(true){
if(cljs.core.seq(m)){
var G__50221 = cljs.core.rest(m);
var G__50222 = (function (){var entry = cljs.core.first(m);
