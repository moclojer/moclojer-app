...
var len__5769__auto___49794 = arguments.length;
var i__5770__auto___49795 = (0);
while(true){
if((i__5770__auto___49795 < len__5769__auto___49794)){
args_arr__5794__auto__.push((arguments[i__5770__auto___49795]));

var G__49796 = (i__5770__auto___49795 + (1));
i__5770__auto___49795 = G__49796;
continue;
} else {
}
break;
...
/** @this {Function} */
(refx.alpha._LT__.cljs$lang$applyTo = (function (seq49730){
var G__49731 = cljs.core.first(seq49730);
var seq49730__$1 = cljs.core.next(seq49730);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__49731,seq49730__$1);
}));

(refx.alpha._LT__.cljs$lang$maxFixedArity = (1));

refx.alpha.parse_reg_sub_sugar = (function refx$alpha$parse_reg_sub_sugar(args){
var vec__49733 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__49736,p__49737){
var vec__49738 = p__49736;
var qs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49738,(0),null);
var f = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49738,(1),null);
var vec__49741 = p__49737;
var op = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49741,(0),null);
var arg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49741,(1),null);
var G__49744 = op;
var G__49744__$1 = (((G__49744 instanceof cljs.core.Keyword))?G__49744.fqn:null);
switch (G__49744__$1) {
case "<-":
...
break;
case "=>":
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [qs,(function (v,p__49745){
var vec__49746 = p__49745;
var seq__49747 = cljs.core.seq(vec__49746);
var first__49748 = cljs.core.first(seq__49747);
var seq__49747__$1 = cljs.core.next(seq__49747);
var _ = first__49748;
var vs = seq__49747__$1;
...
var qs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49733,(0),null);
var f = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49733,(1),null);
...
default:
var args_arr__5794__auto__ = [];
var len__5769__auto___49801 = arguments.length;
var i__5770__auto___49802 = (0);
while(true){
if((i__5770__auto___49802 < len__5769__auto___49801)){
args_arr__5794__auto__.push((arguments[i__5770__auto___49802]));

var G__49803 = (i__5770__auto___49802 + (1));
i__5770__auto___49802 = G__49803;
continue;
} else {
}
break;
...
var vec__49764 = refx.alpha.parse_reg_sub_sugar(cljs.core.list_STAR_.cljs$core$IFn$_invoke$arity$4(x,y,z,args));
var input_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49764,(0),null);
var compute_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49764,(1),null);
...
/** @this {Function} */
(refx.alpha.reg_sub.cljs$lang$applyTo = (function (seq49758){
var G__49759 = cljs.core.first(seq49758);
var seq49758__$1 = cljs.core.next(seq49758);
var G__49760 = cljs.core.first(seq49758__$1);
var seq49758__$2 = cljs.core.next(seq49758__$1);
var G__49761 = cljs.core.first(seq49758__$2);
var seq49758__$3 = cljs.core.next(seq49758__$2);
var G__49762 = cljs.core.first(seq49758__$3);
var seq49758__$4 = cljs.core.next(seq49758__$3);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__49759,G__49760,G__49761,G__49762,seq49758__$4);
}));
...
var len__5769__auto___49817 = arguments.length;
var i__5770__auto___49818 = (0);
while(true){
if((i__5770__auto___49818 < len__5769__auto___49817)){
args__5775__auto__.push((arguments[i__5770__auto___49818]));

var G__49820 = (i__5770__auto___49818 + (1));
i__5770__auto___49818 = G__49820;
continue;
} else {
}
break;
...
(refx.alpha.__GT_interceptor.cljs$core$IFn$_invoke$arity$variadic = (function (p__49786){
var map__49787 = p__49786;
var map__49787__$1 = cljs.core.__destructure_map(map__49787);
var m = map__49787__$1;
...
/** @this {Function} */
(refx.alpha.__GT_interceptor.cljs$lang$applyTo = (function (seq49785){
