...
try{var G__49271_49371 = (function (p1__49258_SHARP_){
return promesa.protocols._resolve_BANG_(d,p1__49258_SHARP_);
});
var G__49272_49372 = (function (p1__49259_SHARP_){
return promesa.protocols._reject_BANG_(d,p1__49259_SHARP_);
});
(f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__49271_49371,G__49272_49372) : f.call(null,G__49271_49371,G__49272_49372));
}catch (e49270){var e_49373 = e49270;
promesa.protocols._reject_BANG_(d,e_49373);
}
return d;
}));
...
try{var G__49280 = (function (p1__49260_SHARP_){
return promesa.protocols._resolve_BANG_(d,p1__49260_SHARP_);
});
var G__49281 = (function (p1__49261_SHARP_){
return promesa.protocols._reject_BANG_(d,p1__49261_SHARP_);
});
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__49280,G__49281) : f.call(null,G__49280,G__49281));
...
var len__5769__auto___49380 = arguments.length;
var i__5770__auto___49381 = (0);
while(true){
if((i__5770__auto___49381 < len__5769__auto___49380)){
args_arr__5794__auto__.push((arguments[i__5770__auto___49381]));

var G__49382 = (i__5770__auto___49381 + (1));
i__5770__auto___49381 = G__49382;
continue;
} else {
}
break;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__49300_SHARP_,p2__49301_SHARP_){
return promesa.core.then.cljs$core$IFn$_invoke$arity$2(p1__49300_SHARP_,p2__49301_SHARP_);
}),p,cljs.core.cons(f,fs));
}));

/** @this {Function} */
(promesa.core.chain.cljs$lang$applyTo = (function (seq49303){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__49304,G__49305,seq49303__$2);
}));
...
args_arr__5794__auto__.push((arguments[i__5770__auto___49385]));
...
/** @this {Function} */
(promesa.core.chain_SINGLEQUOTE_.cljs$lang$applyTo = (function (seq49314){
var G__49315 = cljs.core.first(seq49314);
var seq49314__$1 = cljs.core.next(seq49314);
var G__49316 = cljs.core.first(seq49314__$1);
var seq49314__$2 = cljs.core.next(seq49314__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__49315,G__49316,seq49314__$2);
}));
...
var accept_QMARK_ = ((cljs.core.ifn_QMARK_(pred_or_type))?pred_or_type:(function (p1__49322_SHARP_){
return (p1__49322_SHARP_ instanceof pred_or_type);
}));
...
var accept_QMARK_ = ((cljs.core.ifn_QMARK_(pred_or_type))?pred_or_type:(function (p1__49325_SHARP_){
return (p1__49325_SHARP_ instanceof pred_or_type);
}));
...
var seq__49332 = cljs.core.seq(promises);
var chunk__49333 = null;
var count__49334 = (0);
var i__49335 = (0);
while(true){
if((i__49335 < count__49334)){
var p = chunk__49333.cljs$core$IIndexed$_nth$arity$2(null,i__49335);
promesa.core.catch$.cljs$core$IFn$_invoke$arity$2(promesa.core.then.cljs$core$IFn$_invoke$arity$2(promesa.protocols._promise(p),((function (seq__49332,chunk__49333,count__49334,i__49335,p,state){
return (function (v){
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(state,((function (seq__49332,chunk__49333,count__49334,i__49335,p,state){
...
});})(seq__49332,chunk__49333,count__49334,i__49335,p,state))
);

return (resolve.cljs$core$IFn$_invoke$arity$1 ? resolve.cljs$core$IFn$_invoke$arity$1(v) : resolve.call(null,v));
}
});})(seq__49332,chunk__49333,count__49334,i__49335,p,state))
),((function (seq__49332,chunk__49333,count__49334,i__49335,p,state){
return (function (e){
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(state,((function (seq__49332,chunk__49333,count__49334,i__49335,p,state){
return (function (state__$1){
...
var map__49340 = cljs.core.deref(state);
var map__49340__$1 = cljs.core.__destructure_map(map__49340);
var resolved = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49340__$1,new cljs.core.Keyword(null,"resolved","resolved",968763567));
var counter = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49340__$1,new cljs.core.Keyword(null,"counter","counter",804008177));
var rejections = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49340__$1,new cljs.core.Keyword(null,"rejections","rejections",-1620899911));
...
var G__49341 = cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2("No promises resolved",new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"rejections","rejections",-1620899911),rejections], null));
return (reject.cljs$core$IFn$_invoke$arity$1 ? reject.cljs$core$IFn$_invoke$arity$1(G__49341) : reject.call(null,G__49341));
} else {
...
var G__49395 = seq__49332;
var G__49396 = chunk__49333;
var G__49397 = count__49334;
var G__49398 = (i__49335 + (1));
seq__49332 = G__49395;
chunk__49333 = G__49396;
count__49334 = G__49397;
i__49335 = G__49398;
continue;
} else {
var temp__5804__auto__ = cljs.core.seq(seq__49332);
if(temp__5804__auto__){
var seq__49332__$1 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__49332__$1)){
var c__5568__auto__ = cljs.core.chunk_first(seq__49332__$1);
var G__49399 = cljs.core.chunk_rest(seq__49332__$1);
var G__49400 = c__5568__auto__;
var G__49401 = cljs.core.count(c__5568__auto__);
var G__49402 = (0);
seq__49332 = G__49399;
chunk__49333 = G__49400;
count__49334 = G__49401;
i__49335 = G__49402;
continue;
} else {
var p = cljs.core.first(seq__49332__$1);
promesa.core.catch$.cljs$core$IFn$_invoke$arity$2(promesa.core.then.cljs$core$IFn$_invoke$arity$2(promesa.protocols._promise(p),((function (seq__49332,chunk__49333,count__49334,i__49335,p,seq__49332__$1,temp__5804__auto__,state){
return (function (v){
if(cljs.core.truth_(new cljs.core.Keyword(null,"resolved","resolved",968763567).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(state)))){
return null;
} else {
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(state,((function (seq__49332,chunk__49333,count__49334,i__49335,p,seq__49332__$1,temp__5804__auto__,state){
return (function (state__$1){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(state__$1,new cljs.core.Keyword(null,"resolved","resolved",968763567),true),new cljs.core.Keyword(null,"counter","counter",804008177),cljs.core.dec);
});})(seq__49332,chunk__49333,count__49334,i__49335,p,seq__49332__$1,temp__5804__auto__,state))
);

return (resolve.cljs$core$IFn$_invoke$arity$1 ? resolve.cljs$core$IFn$_invoke$arity$1(v) : resolve.call(null,v));
}
});})(seq__49332,chunk__49333,count__49334,i__49335,p,seq__49332__$1,temp__5804__auto__,state))
),((function (seq__49332,chunk__49333,count__49334,i__49335,p,seq__49332__$1,temp__5804__auto__,state){
return (function (e){
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(state,((function (seq__49332,chunk__49333,count__49334,i__49335,p,seq__49332__$1,temp__5804__auto__,state){
return (function (state__$1){
return cljs.core.update.cljs$core$IFn$_invoke$arity$4(cljs.core.update.cljs$core$IFn$_invoke$arity$3(state__$1,new cljs.core.Keyword(null,"counter","counter",804008177),cljs.core.dec),new cljs.core.Keyword(null,"rejections","rejections",-1620899911),cljs.core.conj,e);
...
var map__49342 = cljs.core.deref(state);
var map__49342__$1 = cljs.core.__destructure_map(map__49342);
var resolved = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49342__$1,new cljs.core.Keyword(null,"resolved","resolved",968763567));
var counter = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49342__$1,new cljs.core.Keyword(null,"counter","counter",804008177));
var rejections = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49342__$1,new cljs.core.Keyword(null,"rejections","rejections",-1620899911));
if(((cljs.core.not(resolved)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(counter,(0))))){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(default$,new cljs.core.Keyword("promesa.core","default","promesa.core/default",1773193826))){
var G__49343 = cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2("No promises resolved",new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"rejections","rejections",-1620899911),rejections], null));
return (reject.cljs$core$IFn$_invoke$arity$1 ? reject.cljs$core$IFn$_invoke$arity$1(G__49343) : reject.call(null,G__49343));
} else {
return (resolve.cljs$core$IFn$_invoke$arity$1 ? resolve.cljs$core$IFn$_invoke$arity$1(default$) : resolve.call(null,default$));
}
} else {
...
var G__49404 = cljs.core.next(seq__49332__$1);
var G__49405 = null;
var G__49406 = (0);
var G__49407 = (0);
seq__49332 = G__49404;
chunk__49333 = G__49405;
count__49334 = G__49406;
i__49335 = G__49407;
continue;
}
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__49344_SHARP_,p2__49345_SHARP_){
return promesa.core.then.cljs$core$IFn$_invoke$arity$2(p1__49344_SHARP_,(function (_){
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(p2__49345_SHARP_) : f.call(null,p2__49345_SHARP_));
}));
...
return (function() { 
var G__49410__delegate = function (args){
return promesa.core.create.cljs$core$IFn$_invoke$arity$1((function (resolve,reject){
...
var G__49410 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__49411__i = 0, G__49411__a = new Array(arguments.length -  0);
while (G__49411__i < G__49411__a.length) {G__49411__a[G__49411__i] = arguments[G__49411__i + 0]; ++G__49411__i;}
  args = new cljs.core.IndexedSeq(G__49411__a,0,null);
} 
return G__49410__delegate.call(this,args);};
G__49410.cljs$lang$maxFixedArity = 0;
G__49410.cljs$lang$applyTo = (function (arglist__49412){
var args = cljs.core.seq(arglist__49412);
return G__49410__delegate(args);
});
G__49410.cljs$core$IFn$_invoke$arity$variadic = G__49410__delegate;
return G__49410;
})()
;
});
