...
var G__48734 = next_offset;
var G__48735 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(res,cur_char);
offset__$1 = G__48734;
res = G__48735;
continue;
}
...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__48657_SHARP_){
return ["%",lambdaisland.uri.platform.byte__GT_hex(p1__48657_SHARP_)].join('');
...
var encode_char = (function (p1__48658_SHARP_){
var G__48661 = p1__48658_SHARP_;
if(cljs.core.truth_(cljs.core.re_find(char_class,p1__48658_SHARP_))){
return lambdaisland.uri.normalize.percent_encode.cljs$core$IFn$_invoke$arity$1(G__48661);
} else {
return G__48661;
}
});
...
return clojure.string.replace(s,/(%[0-9A-Fa-f]{2})+/,(function (p__48664){
var vec__48665 = p__48664;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48665,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48665,(1),null);
...
var G__48741 = (i + (3));
var G__48742 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(res,lambdaisland.uri.normalize.percent_encode.cljs$core$IFn$_invoke$arity$2(lambdaisland.uri.normalize.percent_decode(cljs.core.subs.cljs$core$IFn$_invoke$arity$3(s,i,(i + (3)))),new cljs.core.Keyword(null,"query","query",-1288509510)));
i = G__48741;
res = G__48742;
continue;
} else {
...
var G__48743 = (i + (1));
var G__48744 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(res,cljs.core.subs.cljs$core$IFn$_invoke$arity$3(s,i,(i + (1))));
i = G__48743;
res = G__48744;
continue;
} else {
var increment = ((lambdaisland.uri.normalize.high_surrogate_QMARK_(lambdaisland.uri.platform.char_code_at(s,i)))?(2):(1));
var G__48745 = (i + increment);
var G__48746 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(res,lambdaisland.uri.normalize.percent_encode.cljs$core$IFn$_invoke$arity$2(cljs.core.subs.cljs$core$IFn$_invoke$arity$3(s,i,(i + increment)),new cljs.core.Keyword(null,"query","query",-1288509510)));
i = G__48745;
res = G__48746;
continue;
