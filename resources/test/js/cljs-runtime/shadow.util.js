...
var len__5769__auto___41075 = arguments.length;
var i__5770__auto___41076 = (0);
while(true){
if((i__5770__auto___41076 < len__5769__auto___41075)){
args_arr__5794__auto__.push((arguments[i__5770__auto___41076]));

var G__41078 = (i__5770__auto___41076 + (1));
i__5770__auto___41076 = G__41078;
continue;
} else {
}
break;
...
/** @this {Function} */
(shadow.util.log.cljs$lang$applyTo = (function (seq40935){
var G__40936 = cljs.core.first(seq40935);
var seq40935__$1 = cljs.core.next(seq40935);
var G__40937 = cljs.core.first(seq40935__$1);
var seq40935__$2 = cljs.core.next(seq40935__$1);
var G__40938 = cljs.core.first(seq40935__$2);
var seq40935__$3 = cljs.core.next(seq40935__$2);
var G__40939 = cljs.core.first(seq40935__$3);
var seq40935__$4 = cljs.core.next(seq40935__$3);
var G__40941 = cljs.core.first(seq40935__$4);
var seq40935__$5 = cljs.core.next(seq40935__$4);
var G__40942 = cljs.core.first(seq40935__$5);
var seq40935__$6 = cljs.core.next(seq40935__$5);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__40936,G__40937,G__40938,G__40939,G__40941,G__40942,seq40935__$6);
}));

(shadow.util.log.cljs$lang$maxFixedArity = (6));

shadow.util.remove_from_vector = (function shadow$util$remove_from_vector(coll,key){
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (v,p__41018){
var vec__41021 = p__41018;
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41021,(0),null);
var item = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41021,(1),null);
