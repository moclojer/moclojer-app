...
var vec__49503_49554 = clojure.data.diff(orig_db,new_db);
var only_before_49555 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49503_49554,(0),null);
var only_after_49556 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49503_49554,(1),null);
var db_changed_QMARK__49557 = (((!((only_before_49555 == null)))) || ((!((only_after_49556 == null)))));
if(db_changed_QMARK__49557){
refx.log.info.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["only before:",only_before_49555], 0));

refx.log.info.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["only after :",only_after_49556], 0));
} else {
...
var vec__49506 = refx.interceptor.get_coeffect.cljs$core$IFn$_invoke$arity$2(context,new cljs.core.Keyword(null,"event","event",301435442));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49506,(0),null);
var payload = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49506,(1),null);
var event = vec__49506;
...
var len__5769__auto___49560 = arguments.length;
var i__5770__auto___49561 = (0);
while(true){
if((i__5770__auto___49561 < len__5769__auto___49560)){
args__5775__auto__.push((arguments[i__5770__auto___49561]));

var G__49562 = (i__5770__auto___49561 + (1));
i__5770__auto___49561 = G__49562;
continue;
} else {
}
break;
...
/** @this {Function} */
(refx.interceptors.path.cljs$lang$applyTo = (function (seq49509){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq49509));
}));
...
var new_ins = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49519_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(new_db,p1__49519_SHARP_);
}),in_paths);
var old_ins = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49520_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(old_db,p1__49520_SHARP_);
}),in_paths);
...
/** @this {Function} */
(refx.interceptors.on_changes.cljs$lang$applyTo = (function (seq49521){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__49522,G__49523,seq49521__$2);
}));
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(context,new cljs.core.Keyword(null,"queue","queue",1455835879),(function (p1__49553_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(refx.interceptors.global_interceptors),p1__49553_SHARP_);
}));
})], 0));
