...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__51262_SHARP_){
return html_coll.item(p1__51262_SHARP_);
...
return cljs.core.some((function (p1__51263_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("icon",p1__51263_SHARP_);
...
var ctx_51285 = cvs.getContext("2d");
(ctx_51285.fillStyle = color);

ctx_51285.fillRect((0),(0),size,size);
