...
var G__50006 = cljs.core.next(xs);
var G__50007 = cljs.core.next(ys);
xs = G__50006;
ys = G__50007;
continue;
} else {
...
while(true){
if((n < cnt)){
var nval = (function (){var G__49991 = val;
var G__49992 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__49991,G__49992) : f.call(null,G__49991,G__49992));
})();
...
while(true){
if((n < cnt)){
var nval = (function (){var G__49993 = val__$1;
var G__49994 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__49993,G__49994) : f.call(null,G__49993,G__49994));
})();
if(cljs.core.reduced_QMARK_(nval)){
return cljs.core.deref(nval);
} else {
...
while(true){
if((n < cnt)){
var nval = (function (){var G__49995 = val__$1;
var G__49996 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__49995,G__49996) : f.call(null,G__49995,G__49996));
})();
if(cljs.core.reduced_QMARK_(nval)){
return cljs.core.deref(nval);
} else {
...
var G__50015 = cljs.core.next(es);
var G__50016 = cljs.core._assoc_BANG_(tcoll__$1,cljs.core.key(e),cljs.core.val(e));
es = G__50015;
tcoll__$1 = G__50016;
continue;
} else {
...
var G__50017 = cljs.core._assoc(ret,cljs.core._nth(e,(0)),cljs.core._nth(e,(1)));
var G__50018 = cljs.core.next(es);
ret = G__50017;
es = G__50018;
continue;
} else {
