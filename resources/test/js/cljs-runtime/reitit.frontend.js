...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.juxt.cljs$core$IFn$_invoke$arity$2(cljs.core.keyword,(function (p1__50935_SHARP_){
return reitit.frontend.query_param(q,p1__50935_SHARP_);
})),q.getKeys()));
});
/**
...
(reitit.frontend.match_by_path.cljs$core$IFn$_invoke$arity$3 = (function (router,path,p__50944){
var map__50945 = p__50944;
var map__50945__$1 = cljs.core.__destructure_map(map__50945);
var on_coercion_error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50945__$1,new cljs.core.Keyword(null,"on-coercion-error","on-coercion-error",-970787));
...
}catch (e50947){if((e50947 instanceof Error)){
var e = e50947;
...
if(cljs.core.every_QMARK_((function (p1__50954_SHARP_){
return cljs.core.contains_QMARK_(path_params,p1__50954_SHARP_);
