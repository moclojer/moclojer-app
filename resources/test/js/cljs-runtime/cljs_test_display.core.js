...
var node = (function (){var G__60143 = new cljs.core.Keyword(null,"style","style",-496642736);
var G__60144 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),"cljs-test-display-style"], null);
var G__60145 = style_string_60197;
return (cljs_test_display.core.n.cljs$core$IFn$_invoke$arity$3 ? cljs_test_display.core.n.cljs$core$IFn$_invoke$arity$3(G__60143,G__60144,G__60145) : cljs_test_display.core.n.call(null,G__60143,G__60144,G__60145));
})();
...
var len__5769__auto___60198 = arguments.length;
var i__5770__auto___60199 = (0);
while(true){
if((i__5770__auto___60199 < len__5769__auto___60198)){
args__5775__auto__.push((arguments[i__5770__auto___60199]));

var G__60200 = (i__5770__auto___60199 + (1));
i__5770__auto___60199 = G__60200;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs_test_display.core.n.cljs$lang$applyTo = (function (seq60147){
var G__60148 = cljs.core.first(seq60147);
var seq60147__$1 = cljs.core.next(seq60147);
var G__60149 = cljs.core.first(seq60147__$1);
var seq60147__$2 = cljs.core.next(seq60147__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__60148,G__60149,seq60147__$2);
}));
...
var vec__60161 = ((clojure.string.starts_with_QMARK_(cljs.core.first(classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.first(classes),(1)),cljs.core.rest(classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60161,(0),null);
var classes__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60161,(1),null);
var G__60164 = cljs.core.PersistentArrayMap.EMPTY;
var G__60164__$1 = (cljs.core.truth_(id)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__60164,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__60164);
if(cljs.core.truth_(cljs.core.not_empty(classes__$1))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__60164__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",classes__$1));
} else {
return G__60164__$1;
}
} else {
...
return (function() { 
var G__60201__delegate = function (klass,contents){
var vec__60165 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons(klass,contents)], null));
var klass__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60165,(0),null);
var contents__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60165,(1),null);
...
var G__60201 = function (klass,var_args){
var contents = null;
if (arguments.length > 1) {
var G__60202__i = 0, G__60202__a = new Array(arguments.length -  1);
while (G__60202__i < G__60202__a.length) {G__60202__a[G__60202__i] = arguments[G__60202__i + 1]; ++G__60202__i;}
  contents = new cljs.core.IndexedSeq(G__60202__a,0,null);
} 
return G__60201__delegate.call(this,klass,contents);};
G__60201.cljs$lang$maxFixedArity = 1;
G__60201.cljs$lang$applyTo = (function (arglist__60203){
var klass = cljs.core.first(arglist__60203);
var contents = cljs.core.rest(arglist__60203);
return G__60201__delegate(klass,contents);
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__60173){
var map__60174 = p__60173;
var map__60174__$1 = cljs.core.__destructure_map(map__60174);
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60174__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60174__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__60184){
var map__60185 = p__60184;
var map__60185__$1 = cljs.core.__destructure_map(map__60185);
var actual = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60185__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60185__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__60186){
var map__60187 = p__60186;
var map__60187__$1 = cljs.core.__destructure_map(map__60187);
var expected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60187__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60187__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__60188_SHARP_){
return cljs.core.cons(new_current_node,p1__60188_SHARP_);
}));
...
var curr_node = cljs_test_display.core.current_node();
var map__60190 = cljs_test_display.core.current_var_info();
var map__60190__$1 = cljs.core.__destructure_map(map__60190);
var info = map__60190__$1;
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60190__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60190__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60190__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__60189_SHARP_){
return cljs.core.cons(node,p1__60189_SHARP_);
}));

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__60191){
var map__60192 = p__60191;
var map__60192__$1 = cljs.core.__destructure_map(map__60192);
var m = map__60192__$1;
var fail = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60192__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60192__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60192__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60192__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["expected:",(function (){var G__60193 = new cljs.core.Keyword(null,"expected","expected",1583670997).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__60193) : formatter_fn.call(null,G__60193));
})()], 0));

return cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["  actual:",(function (){var G__60194 = new cljs.core.Keyword(null,"actual","actual",107306363).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__60194) : formatter_fn.call(null,G__60194));
})()], 0));
});
...
var temp__5804__auto___60205 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5804__auto___60205)){
var message_60206 = temp__5804__auto___60205;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_60206], 0));
} else {
}
...
var temp__5804__auto___60207 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5804__auto___60207)){
var message_60208 = temp__5804__auto___60207;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_60208], 0));
} else {
}
