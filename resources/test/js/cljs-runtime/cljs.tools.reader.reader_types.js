...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_40487 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_40487(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_40488 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_40488(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_40496 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_40496(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_40500 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_40500(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_40501 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_40501(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_40506 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_40506(reader);
}
});
...
var G__40554 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__40555 = s.append(c);
c = G__40554;
s = G__40555;
continue;
}
