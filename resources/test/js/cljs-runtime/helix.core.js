...
var len__5769__auto___50270 = arguments.length;
var i__5770__auto___50271 = (0);
while(true){
if((i__5770__auto___50271 < len__5769__auto___50270)){
args__5775__auto__.push((arguments[i__5770__auto___50271]));

var G__50272 = (i__5770__auto___50271 + (1));
i__5770__auto___50271 = G__50272;
continue;
} else {
}
break;
...
/** @this {Function} */
(helix.core.$.cljs$lang$applyTo = (function (seq50225){
var G__50227 = cljs.core.first(seq50225);
var seq50225__$1 = cljs.core.next(seq50225);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50227,seq50225__$1);
}));
...
var helix$core$IExtractType$_type$dyn_50273 = (function (factory){
...
return helix$core$IExtractType$_type$dyn_50273(factory);
}
});
...
var G__50275__i = 0, G__50275__a = new Array(arguments.length -  0);
while (G__50275__i < G__50275__a.length) {G__50275__a[G__50275__i] = arguments[G__50275__i + 0]; ++G__50275__i;}
  args = new cljs.core.IndexedSeq(G__50275__a,0,null);
} 
return helix$core$factory_$_factory__delegate.call(this,args);};
helix$core$factory_$_factory.cljs$lang$maxFixedArity = 0;
helix$core$factory_$_factory.cljs$lang$applyTo = (function (arglist__50276){
var args = cljs.core.seq(arglist__50276);
...
;
(x50236.helix$core$IExtractType$ = cljs.core.PROTOCOL_SENTINEL);

(x50236.helix$core$IExtractType$_type$arity$1 = (function (_){
var ___$1 = this;
return type;
}));
...
while (G__50277__i < G__50277__a.length) {G__50277__a[G__50277__i] = arguments[G__50277__i + 0]; ++G__50277__i;}
  args = new cljs.core.IndexedSeq(G__50277__a,0,null);
} 
...
helix$core$cljs_factory_$_factory.cljs$lang$applyTo = (function (arglist__50281){
...
;
(x50245.helix$core$IExtractType$ = cljs.core.PROTOCOL_SENTINEL);

(x50245.helix$core$IExtractType$_type$arity$1 = (function (_){
var ___$1 = this;
return type;
}));
...
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.count(prev_props),cljs.core.count(cur_props))) && (cljs.core.every_QMARK_((function (p1__50252_SHARP_){
return (cljs.core.get.cljs$core$IFn$_invoke$arity$2(prev_props,p1__50252_SHARP_) === cljs.core.get.cljs$core$IFn$_invoke$arity$2(cur_props,p1__50252_SHARP_));
...
var G__50265 = helix.core.extract_cljs_props(o);
var G__50266 = helix.core.extract_cljs_props(o_SINGLEQUOTE_);
return (compare.cljs$core$IFn$_invoke$arity$2 ? compare.cljs$core$IFn$_invoke$arity$2(G__50265,G__50266) : compare.call(null,G__50265,G__50266));
}));
}));
...
var G__50267 = this$;
var G__50268 = helix.core.extract_cljs_props(this$.props);
var G__50269 = this$.state;
return (render.cljs$core$IFn$_invoke$arity$3 ? render.cljs$core$IFn$_invoke$arity$3(G__50267,G__50268,G__50269) : render.call(null,G__50267,G__50268,G__50269));
});
